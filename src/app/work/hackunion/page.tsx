...
import { HackUnionCaseStudy } from "@/components/sections/hackunion-case-study";
...
export default function HackUnionRoutePage() {
  return (
    <ShellContainer>
      <div className="case-study-page-wrapper">
        <nav className="case-study-breadcrumb" aria-label="Breadcrumb">
          ...
          <span className="case-study-breadcrumb-current">HackUnion</span>
        </nav>
